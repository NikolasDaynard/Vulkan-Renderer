#ifndef SWAPCHAINHELPERS_H_INCLUDED
#define SWAPCHAINHELPERS_H_INCLUDED
...
void createSwapChain(VkSwapchainKHR &swapChain, VkFormat &swapChainImageFormat, VkExtent2D &swapChainExtent, std::vector<VkImage> &swapChainImages, VkDevice device, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, GLFWwindow* window) {
...
void recreateSwapChain(VkSwapchainKHR &swapChain, VkFormat &swapChainImageFormat, VkExtent2D &swapChainExtent, std::vector<VkImage> &swapChainImages, std::vector<VkImageView> &swapChainImageViews, std::vector<VkFramebuffer> &swapChainFramebuffers, VkRenderPass renderPass, VkDevice device, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, GLFWwindow* window) {
