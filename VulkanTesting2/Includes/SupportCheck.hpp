#ifndef SUPPORTCHECK_H_INCLUDED
#define SUPPORTCHECK_H_INCLUDED
...
bool isDeviceSuitable(VkPhysicalDevice device, VkSurfaceKHR surface, std::vector<const char*> deviceExtentions) {
